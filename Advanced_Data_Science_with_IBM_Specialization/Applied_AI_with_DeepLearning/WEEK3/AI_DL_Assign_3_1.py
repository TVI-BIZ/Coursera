...
number_of_neurons_layer1 = 300
number_of_neurons_layer2 = 200 #### your code here ###
...
def train(data,label):
    model.fit(data_healthy_scaled, label_healthy, epochs=number_of_epochs, batch_size=72, validation_data=(data, label), verbose=0, shuffle=True,callbacks=[lr])
...
features = train_both[:6,1:]
labels = train_both[:6,3000:]
#features.shape
#features.view()
#labels.shape
#labels.view()
